;;; .ecb-user-layout.el --- user defined ECB-layouts
...
(ecb-layout-define "falkor" left nil
  (ecb-split-ver 0.4 t)
  ...
  (dotimes (i 2) (other-window 1) (if (equal (selected-window) ecb-compile-window) (other-window 1)))
  (dotimes (i 4) (other-window 1) (if (equal (selected-window) ecb-compile-window) (other-window 1)))
  )
